...
```
GET /{dataset}.{extension}?organisation-entity={value}&quality={value}&fields={column1}&fields={column2}
```
...
- `fields` (optional): Select specific columns to include in output. Can be specified multiple times for multiple columns (e.g., `?fields=id&fields=name`)
...
GET /conservation-area.csv?fields=entity&fields=name&fields=geometry

# Combine row filtering and column selection
GET /conservation-area.json?organisation-entity=122&fields=entity&fields=reference&fields=name
```
